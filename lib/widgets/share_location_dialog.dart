...
Future<Object?> showSharingLocationDialog(
  BuildContext context, {
  required UserBookingBloc bookingBloc, // ✅ captured bloc
  ...
  String subtitle =
      "Taskoon Support can see your live location.\nStay calm — help is on the way.",
  VoidCallback? onCall,
  required Future<void> Function() onStopSharing, // ✅ manager persists OFF here
      ...
      return Center(
        child: Material(
          ...
          child: BlocProvider.value(
            value: bookingBloc, // ✅ dialog can BlocBuilder safely
            child: _SharingLocationDialogBody(
              ...
              // ✅ start SOS exactly once when dialog opens
              onStart: () {
                bookingBloc.add(
                  StartSosRequested(
...
class _SharingLocationDialogBody extends StatefulWidget {
  ...
  @override
  State<_SharingLocationDialogBody> createState() =>
      _SharingLocationDialogBodyState();
}
...
class _SharingLocationDialogBodyState extends State<_SharingLocationDialogBody>
  ...
  void initState() {
    ...
    // ✅ start SOS once after dialog paints
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<UserBookingBloc, UserBookingState>(
      buildWhen: (p, c) =>
          p.startSosStatus != c.startSosStatus ||
          p.updateSosLocationStatus != c.updateSosLocationStatus,
      builder: (ctx, state) {
        final isStarting = state.startSosStatus == StartSosStatus.submitting;
        final isActive = state.startSosStatus == StartSosStatus.success;
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                ...
                                colors: [kPrimary, kPrimary.withOpacity(.75)],
                              ),
                              boxShadow: [
                                BoxShadow(
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(
                              color:
                                  const Color(0xFFE53935).withOpacity(.55)),
...
class _PulsePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < dotCount; i++) {
      ...
      final p = Offset(center.dx + orbit * math.cos(angle),
