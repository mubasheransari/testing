...
// NOTE: these model types are assumed from your project imports
// TaskerDashboardResponse, TaskerEarningsStatsResponse, TaskerEarningsChartResponse,
// StartSosResult, RegistrationResponse, PaymentIntentResponse,
// BookingCreateResponse, BookingFindResponse
...
class UserBookingState extends Equatable {
  ...
  // ✅ Earnings Chart (latest response + status)
  ...
  // ✅ NEW: Earnings Chart cache by period: "today" | "week" | "month"
