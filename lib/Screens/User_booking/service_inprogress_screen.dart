...
import 'package:taskoon/Screens/User_booking/chat_screen.dart';
import 'dart:ui';
...
class _ServiceProgressScreenState extends State<ServiceProgressScreen> {
  ...
  void _goToRating() {
    ...
    Future.delayed(const Duration(milliseconds: 250), () {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (_) => const RateTaskerScreen(
            taskerName: 'Stephan Micheal',
            jobCode: 'AU737',
          ),
        ),
      );
  ...
  void _openChatScreen() {
    ...
    final tasker = ChatParticipant(
      id: 't1',
      name: 'Micheal Stance',
      isVerified: true,
    );

    final booking = ChatBookingInfo(
      bookingId: 'AU737',
      serviceName: 'Cleaning Service',
      status: 'In Progress',
      dateTimeLabel: '16 Mar 2026 • 4:00 PM',
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ChattScreen(
          viewerRole: ViewerRole.user, // ✅ user side chat
          user: user,
          tasker: tasker,
          bookingInfo: booking,
        ),
  ...
  Widget build(BuildContext context) {
    ...
    switch (_stage) {
      case 0:
        title = 'Service has begun!';
        asset = 'assets/service_begin_1.png';
        steps = [1, 0, 0];
        break;
      case 1:
        title = 'Service in progress';
