...
// keep your imports for blocs, dto, screens etc
...
class _UserBookingHomeState extends State<UserBookingHome> {
  ...
  // Optional: if you want logs/handling on this screen
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // ✅ configure + connect singleton once
      ...
      // OPTIONAL: listen here (remove if not needed)
      _hubSub?.cancel();
  ...
  @override
  void dispose() {
    // ✅ DO NOT stop hub here. Only unsubscribe.
    _hubSub?.cancel();
    super.dispose();
  }
...
//       if (offer != null) {
//         _log(
//           "✅ BookingOffer parsed → bookingDetailId=${offer.bookingDetailId}",
//         );
...
class _UserBookingHomeState extends State<UserBookingHome> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (userId == null || userId.isEmpty) {
        debugPrint(
          "❌ UserBookingHome: userId missing (userDetails not loaded)",
        );
        return;
      }
