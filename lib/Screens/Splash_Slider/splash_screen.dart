...
class _SplashScreenState extends State<SplashScreen>
  ...
  bool _isInitDone(AuthenticationState s) {
    ...
    final docsDone =
        s.documentsStatus == DocumentsStatus.success ||
        s.documentsStatus == DocumentsStatus.failure;

    final videosDone =
        s.trainingVideosStatus == TrainingVideosStatus.success ||
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [_primaryAlt, _primary, const Color(0xFF1B1B1F)],
        ),
      ),
    );
  }
